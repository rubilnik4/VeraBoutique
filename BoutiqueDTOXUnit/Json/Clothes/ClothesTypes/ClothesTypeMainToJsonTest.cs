...
namespace BoutiqueDTOXUnit.Json.Clothes.ClothesTypes
{
    ...
    /// </summary>
    public class ClothesTypeMainToJsonTest
    {
        /// <summary>
        ...
        {
            var clothesTypeTransfer = ClothesTypeTransfersData.ClothesTypeMainTransfers.First();

            string json = JsonConvert.SerializeObject(clothesTypeTransfer);
            var clothesTypeAfterJson = JsonConvert.DeserializeObject<ClothesTypeMainTransfer>(json);
