...
namespace BoutiqueCommon.Models.Domain.Implementations.Clothes.SizeGroupDomain
{
    ...
    /// </summary>
    public class SizeGroupFullDomain : SizeGroupFullBase<ISizeDomain>, ISizeGroupFullDomain
    {
        public SizeGroupFullDomain(ISizeGroupBase sizeGroup, IEnumerable<ISizeDomain> sizes)
            : this(sizeGroup.ClothesSizeType, sizeGroup.SizeNormalize, sizes)
        { }

        public SizeGroupFullDomain(ClothesSizeType clothesSizeType, int sizeNormalize, IEnumerable<ISizeDomain> sizes)
