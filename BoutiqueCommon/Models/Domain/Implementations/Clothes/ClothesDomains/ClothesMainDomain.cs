...
{
    public class ClothesMainDomain : ClothesMainBase<IClothesImageDomain, IGenderDomain, IClothesTypeDomain, IColorDomain, ISizeGroupMainDomain, ISizeDomain>, 
                                     IClothesMainDomain
    {
        ...
        public ClothesMainDomain(int id, string name, string description, decimal price, IEnumerable<IClothesImageDomain> images,
                                 IGenderDomain gender, IClothesTypeDomain clothesType,
                                 IEnumerable<IColorDomain> colors, IEnumerable<ISizeGroupMainDomain> sizeGroups)
