...
namespace BoutiqueCommon.Models.Common.Implementations.Clothes.Clothes
{
    ...
    /// Одежда. Информация
    /// </summary>
    public abstract class ClothesInformation : ClothesShort, IClothes, IEquatable<IClothes>
    {
        ...
        #region IEquatable
        public override bool Equals(object? obj) => obj is IClothes clothes && Equals(clothes);

        public bool Equals(IClothes? other) =>
