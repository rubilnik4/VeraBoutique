...
namespace BoutiqueDAL.Infrastructure.Implementations.Converters.Clothes.ClothesEntities
{
                                          ...
                                          IClothesEntityConverter
    {
        ...
        public override IResultValue<IClothesDomain> FromEntity(ClothesEntity clothesEntity) =>
            ...
            ResultCurryOkBind(ColorClothesFromComposite(clothesEntity.ClothesColorComposites)).
            ResultCurryOkBind(SizeGroupFromComposite(clothesEntity.ClothesSizeGroupComposites)).
        ...
        /// </summary>
        private static IResultCollection<ColorClothesEntity> GetColorClothes(IEnumerable<ClothesColorCompositeEntity> clothesColorEntities) =>
