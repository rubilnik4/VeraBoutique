...
namespace BoutiqueDAL.Infrastructure.Implementations.Converters.Clothes.ClothesTypeEntities
{
                                                   ...
                                                   IClothesTypeShortEntityConverter
    {
        ...
        /// </summary>
        public override IResultValue<IClothesTypeShortDomain> FromEntity(ClothesTypeShortEntity clothesTypeEntity) =>
            new ClothesTypeShortDomain(clothesTypeEntity).
        ...
        /// </summary>
        public override ClothesTypeShortEntity ToEntity(IClothesTypeShortDomain clothesTypeDomain) =>
            new ClothesTypeShortEntity(clothesTypeDomain);
    }
}