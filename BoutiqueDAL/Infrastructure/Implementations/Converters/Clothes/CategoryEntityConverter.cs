...
namespace BoutiqueDAL.Infrastructure.Implementations.Converters.Clothes
{
    ...
    /// </summary>
    public class CategoryEntityConverter : EntityConverter<string, ICategoryDomain, CategoryEntity>, ICategoryEntityConverter
    {
        /// <summary>
        /// Преобразовать категорию одежды из модели базы данных
        /// </summary>
        public override ICategoryDomain FromEntity(CategoryEntity categoryEntity) =>
