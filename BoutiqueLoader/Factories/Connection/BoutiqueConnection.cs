...
namespace BoutiqueLoader.Factories.Connection
{
    /// <summary>
    ...
    public static class BoutiqueConnection
    {
        ...
        /// Параметры подключения к серверу Boutique
        /// </summary>
        public static IResultValue<IHostConfigurationDomain> BoutiqueHostConnection =>
        ...
        /// </summary>
        private static IResultValue<Func<Uri, int, IHostConfigurationDomain>> BoutiqueConnectionFunc =>
            new ResultValue<Func<Uri, int, IHostConfigurationDomain>>((host, timeOut) =>
                new HostConfigurationDomain(host, TimeSpan.FromSeconds(timeOut), false));
