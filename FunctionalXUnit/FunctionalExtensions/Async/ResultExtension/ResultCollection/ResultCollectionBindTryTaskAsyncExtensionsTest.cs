...
namespace FunctionalXUnit.FunctionalExtensions.Async.ResultExtension.ResultCollection
{
    ...
    public class ResultCollectionBindTryTaskAsyncExtensionsTest
    {
        ...
        /// </summary>
        [Fact]
        public async Task ResultCollectionBindTryOk_OkResult_OkTry()
        {
            ...
            var numbersAfterTry = await numbersResult.ResultValueBindTryOkTaskAsync(DivisionByCollection, CreateErrorTest());
        ...
        /// </summary>
        [Fact]
        public async Task ResultCollectionBindTryOk_ErrorResult_OkTry()
        {
        ...
        /// </summary>
        [Fact]
        public async Task ResultCollectionBindTryOk_OkResult_ExceptionTry()
        {
            var initialNumbers = GetRangeNumber();
            var numberResult = Task.FromResult((IResultCollection<int>)new ResultCollection<int>(initialNumbers));

            var numbersAfterTry = await numberResult.ResultValueBindTryOkTaskAsync(DivisionCollectionByZero, Exceptions.ExceptionError());
        ...
        /// </summary>
        [Fact]
        public async Task ResultCollectionBindTryOk_ErrorResult_ExceptionTry()
        {
            var initialError = CreateErrorTest();
            var numbersResult = Task.FromResult((IResultCollection<int>)new ResultCollection<int>(initialError));

            var numberAfterTry = await numbersResult.ResultValueBindTryOkTaskAsync(DivisionCollectionByZero, Exceptions.ExceptionError());
