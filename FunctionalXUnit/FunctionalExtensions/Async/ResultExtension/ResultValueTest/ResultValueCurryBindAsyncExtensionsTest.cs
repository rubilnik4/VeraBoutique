...
namespace FunctionalXUnit.FunctionalExtensions.Async.ResultExtension.ResultValueTest
{
    ...
    /// </summary>
    public class ResultValueCurryBindAsyncExtensionsTest
    {
        /// <summary>
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkBindAsync_OkStatus_AddOkStatus()
        {
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkBindAsync_BadStatus_AddOkStatus()
        {
            int initialValue = Numbers.Number;
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkBindAsync_BadStatus_AddOkStatus_TwoArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<int, Task<string>>>(errorFunc);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkBindAsync_BadStatus_AddOkStatus_ThreeArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<int, Task<string>>>(errorFunc);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkBindAsync_BadStatus_AddOkStatus_FourArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<int, Task<string>>>(errorFunc);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkBindAsync_BadStatus_AddOkStatus_FiveArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<int, Task<string>>>(errorFunc);
