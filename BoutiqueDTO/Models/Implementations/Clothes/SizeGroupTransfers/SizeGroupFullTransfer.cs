...
namespace BoutiqueDTO.Models.Implementations.Clothes.SizeGroupTransfers
{
    ...
    /// </summary>
    public class SizeGroupFullTransfer : SizeGroupFullBase<SizeTransfer>, ISizeGroupFullTransfer
    {
        public SizeGroupFullTransfer(ISizeGroupBase sizeGroup, IEnumerable<SizeTransfer> sizes)
            : this(sizeGroup.ClothesSizeType, sizeGroup.SizeNormalize, sizes.ToList())
        { }

        [JsonConstructor]
        public SizeGroupFullTransfer(ClothesSizeType clothesSizeType, int sizeNormalize, IReadOnlyCollection<SizeTransfer> sizes)
