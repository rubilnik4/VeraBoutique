...
namespace BoutiqueDTO.Infrastructure.Implementations.Services.Api.Clothes
{
    ...
    public class CategoryApiService : ApiService<string, CategoryTransfer>, ICategoryApiService
    {
        ...
        /// Получить сервис
        /// </summary>
        public static ICategoryApiService GetCategoryApiService(IHostConnection hostConnection) =>
            new CategoryApiService(RestSharpFactory.GetRestClient(hostConnection));
    }
}